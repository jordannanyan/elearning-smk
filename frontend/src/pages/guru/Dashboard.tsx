...
export default function GuruDashboard() {
  ...
  const kartu = [
    ['Kelas Mata Pelajaran', d.total_kelas_mapel],
    ['Siswa Diampu', d.total_siswa],
    ['Pertemuan', d.total_pertemuan],
    ...
    <div>
      ...
      <div className="card">
        ...
        <p className="muted" style={{ lineHeight: 1.8 }}>
          Alur mengajar pada sistem ini: buka <strong>Kelas Saya</strong> → pilih kelas mata pelajaran →
