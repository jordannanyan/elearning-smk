...
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (1,'Administrator','admin@smakk.sch.id','$2a$10$2WbvRF9b6ye.pIbKnl8dpecfDRX5tCwNOmCNgCFeG1RGPnGt7Drzm','admin',NULL,1,'2026-09-22 14:57:08');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (2,'Budi Santoso, S.Pd','budi@smakk.sch.id','$2a$10$jAvAqUWddeMXrkedYHLVEenA9FZCUGUZa88V.y91cLWfETvuSR8D.','guru',NULL,1,'2026-09-22 14:57:08');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (3,'Siti Aminah, S.Pd','siti@smakk.sch.id','$2a$10$sPjHU6wyTB/R.5Pe2JISB.O2ck.bJrfMWLyDOlitv5LEcuScZak4m','guru',NULL,1,'2026-09-22 14:57:08');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (4,'Rahmat Hidayat, S.Pd','rahmat@smakk.sch.id','$2a$10$Ph0U.N3Jqgd/4M5GebjHvOvGngfJkTKoPPE5EMScXCoYtsF.Cjpl6','guru',NULL,1,'2026-09-22 14:57:09');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (5,'Dina Marlina, S.Pd','dina@smakk.sch.id','$2a$10$QgjYjr7KexQhnTf2gh88Ou7J6FTtxQxYmkyCH9/Ky91mjgucEeIuC','guru',NULL,1,'2026-09-22 14:57:09');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (6,'Hendra Wijaya, S.Pd','hendra@smakk.sch.id','$2a$10$i5wpAYPTYtRTYugIj97Obe8Fd5O3vRbFZBmmXmYB9Y8GANeGGMFiG','guru',NULL,1,'2026-09-22 14:57:09');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (7,'Lestari Ningsih, S.Pd','lestari@smakk.sch.id','$2a$10$PzjINQTYAcJu3asQT50OT.1pa5pKe2BLkNp8GicaMGVcdovmJZub6','guru',NULL,1,'2026-09-22 14:57:09');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (8,'Ahmad Fauzi','ahmad@siswa.smakk.sch.id','$2a$10$OB9xOv16U9E4h1jyb4CC9.a29Vvze/JgzUZoGxM6g3pC5hsDNRKnq','siswa',NULL,1,'2026-09-22 14:57:09');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (9,'Dewi Lestari','dewi@siswa.smakk.sch.id','$2a$10$ofsbWqL1KFZZcv0xvJ5oOuseW2YRzCjrrPJoFshtKzsTzgc.0FLmu','siswa',NULL,1,'2026-09-22 14:57:09');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (10,'Rian Pratama','rian@siswa.smakk.sch.id','$2a$10$yv1yI8Qz296MWyIMcUL2oeoGw7jf87J9f61tG1E4fiXISSh0ZLQpq','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (11,'Nur Aisyah','aisyah@siswa.smakk.sch.id','$2a$10$cCKjjquLCKK7UTM73gVYaeXqBz04DYgkDqPx8w6Ru9crtGaOm.0e2','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (12,'Bayu Saputra','bayu@siswa.smakk.sch.id','$2a$10$NdoYwkBCyn0MTKvPCcu7WemXp6l9cjtmusUyPC5lWLf83SSAX2FPO','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (13,'Putri Rahmawati','putri@siswa.smakk.sch.id','$2a$10$FvuA3KuctP8FjNWoRR946uU/h/xwZ02HhbLR8jN1mFFkVh0/dqQWe','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (14,'Fajar Ramadhan','fajar@siswa.smakk.sch.id','$2a$10$jmBaIUc6C62XQEloHqVla.zwJ43/HqDEtpmoElmmGSXxmiFhQQg/e','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (15,'Salsabila Azzahra','salsa@siswa.smakk.sch.id','$2a$10$p.OmNA1s7qBZmM.2pk251uZp4Vjl3.mYfKm6MlCPwCCrlQJ5XII.m','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (16,'Andi Setiawan','andi@siswa.smakk.sch.id','$2a$10$wINw9abHvGE1dvdinTq2Ke9vHLEsKJ2HzGNt/cvvIYbWOaJiuAX5m','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (17,'Maya Anggraini','maya@siswa.smakk.sch.id','$2a$10$q83lNqR9ARSsB3Tk.U6t/.vGxs4OQOVkC2qiQKPCJ9L.TxXotfP9C','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (18,'Rizky Alamsyah','rizky@siswa.smakk.sch.id','$2a$10$xsyWWfx4opMuXTsj8Qh6Be/FDw4WJXhO5R2Y0OFdugU4uNTTd4w3y','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (19,'Intan Permata','intan@siswa.smakk.sch.id','$2a$10$ffRWfh.mTzeQr/KrpdGXIec8.eQqp16C8I3Cg31k6VHUzVFDYcFt2','siswa',NULL,1,'2026-09-22 14:57:10');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (20,'Galih Nugroho','galih@siswa.smakk.sch.id','$2a$10$qUA3Ws1uHByDv1QHiwm1uuFyQ3B0Yg0ttNFNdof0pME8xX/1nSggW','siswa',NULL,1,'2026-09-22 14:57:11');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (21,'Winda Oktaviani','winda@siswa.smakk.sch.id','$2a$10$zjVuIQqCoVK6zorXSeAAd./2muVH3Gy.VnLwbeFJzLq9FSvlDC1ga','siswa',NULL,1,'2026-09-22 14:57:11');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (22,'Teguh Prasetyo','teguh@siswa.smakk.sch.id','$2a$10$wZz5JnG9k99wTscKMWpYSOK5YrMrLX6Lxie7OjDfjadeQbIJZ1QnG','siswa',NULL,1,'2026-09-22 14:57:11');
INSERT INTO `users` (`id`, `nama`, `email`, `password`, `role`, `foto`, `aktif`, `created_at`) VALUES (24,'Wulan Safitri','wulan@siswa.smakk.sch.id','$2a$10$mCKSU23J.Rb0CRfUOMYR8eXZkJwUYqMSaI0sk6mKm2KzfFJOa4yCO','siswa',NULL,1,'2026-09-22 14:57:12');
...
INSERT INTO `periode` (`id`, `kode`, `tahun_ajaran`, `semester`, `tgl_mulai`, `tgl_selesai`, `status`, `dikunci_oleh`, `tgl_dikunci`, `created_at`) VALUES (1,'2025/2','2024/2025',2,'2025-01-06','2025-06-20','terkunci',1,'2025-06-25 10:00:00','2026-09-22 14:57:08');
INSERT INTO `periode` (`id`, `kode`, `tahun_ajaran`, `semester`, `tgl_mulai`, `tgl_selesai`, `status`, `dikunci_oleh`, `tgl_dikunci`, `created_at`) VALUES (2,'2026/1','2025/2026',1,'2025-07-14','2025-12-19','aktif',NULL,NULL,'2026-09-22 14:57:08');
...
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (1,1,1,'Konsep Persamaan Linear Satu Variabel','Pengenalan bentuk umum persamaan linear satu variabel serta cara menentukan penyelesaiannya.','2026-09-01','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (2,1,2,'Pertidaksamaan Linear Satu Variabel','Sifat-sifat pertidaksamaan linear dan penyajian himpunan penyelesaian pada garis bilangan.','2026-09-08','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (3,1,3,'Sistem Persamaan Linear Dua Variabel','Penyelesaian SPLDV dengan metode substitusi, eliminasi, dan campuran.','2026-09-15','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (4,2,1,'Struktur dan Kaidah Teks Deskripsi','Mengenal struktur teks deskripsi serta kaidah kebahasaan yang digunakan.','2026-09-02','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (5,2,2,'Menelaah Teks Deskripsi','Menelaah penggunaan kata konkret dan majas dalam teks deskripsi.','2026-09-09','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (6,2,3,'Teks Eksposisi','Pengertian, struktur, dan ciri kebahasaan teks eksposisi.','2026-09-16','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (7,3,1,'Besaran dan Satuan','Besaran pokok, besaran turunan, dan satuan Sistem Internasional.','2026-09-03','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (8,3,2,'Vektor dan Resultan Gaya','Penjumlahan vektor dan penguraian vektor pada sumbu x dan y.','2026-09-10','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (9,4,1,'Descriptive Text','Social function, generic structure, and language features.','2026-09-04','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (10,5,1,'Struktur Atom','Perkembangan model atom dan konfigurasi elektron.','2026-09-05','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (11,6,1,'Berpikir Komputasional','Dekomposisi, pengenalan pola, abstraksi, dan algoritma.','2026-09-06','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (12,7,1,'Konsep Persamaan Linear Satu Variabel','Pengenalan persamaan linear satu variabel untuk kelas X MIPA 2.','2026-09-01','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (13,11,1,'Teks Prosedur Kompleks','Struktur dan kaidah kebahasaan teks prosedur kompleks.','2026-09-07','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (14,16,1,'Barisan dan Deret Aritmetika','Materi barisan dan deret aritmetika pada semester genap tahun ajaran 2024/2025.','2026-01-25','2026-09-22 14:57:11');
INSERT INTO `pertemuan` (`id`, `id_kelas_mapel`, `nomor`, `judul`, `deskripsi`, `tanggal`, `created_at`) VALUES (15,17,1,'Teks Negosiasi','Struktur dan kaidah teks negosiasi.','2026-01-27','2026-09-22 14:57:11');
...
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (1,1,'Pengantar Persamaan Linear Satu Variabel','Persamaan linear satu variabel adalah persamaan yang memuat tepat satu variabel berpangkat satu. Bentuk umumnya ax + b = 0 dengan a tidak sama dengan nol.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (2,1,'Modul Persamaan Linear Satu Variabel (PDF)','Modul lengkap beserta contoh soal dan pembahasan.','file','modul_persamaan_linear.pdf',NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (3,1,'Video Pembelajaran Persamaan Linear Satu Variabel','Rekaman penjelasan langkah penyelesaian persamaan linear satu variabel beserta contoh pengerjaannya.','video','video_persamaan_linear.webm',NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (4,2,'Sifat-Sifat Pertidaksamaan Linear','Apabila kedua ruas dikalikan atau dibagi bilangan negatif, maka tanda pertidaksamaan berbalik arah.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (5,3,'Metode Penyelesaian SPLDV','SPLDV dapat diselesaikan dengan metode substitusi, eliminasi, campuran, maupun grafik. Pemilihan metode disesuaikan dengan bentuk persamaannya.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (6,3,'Video Pengayaan: Transformasi Linear dan Matriks','Tautan video pengayaan mengenai hubungan sistem persamaan linear dengan matriks.','link',NULL,'https://www.youtube.com/watch?v=kYB8IZa5AuE','2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (7,4,'Pengertian dan Struktur Teks Deskripsi','Teks deskripsi menggambarkan objek secara rinci sehingga pembaca seolah-olah melihat sendiri objek yang digambarkan. Strukturnya terdiri atas identifikasi, deskripsi bagian, dan penutup.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (8,4,'Modul Teks Deskripsi (PDF)','Modul lengkap teks deskripsi beserta contoh.','file','modul_teks_deskripsi.pdf',NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (9,5,'Kata Konkret dan Majas dalam Teks Deskripsi','Kata konkret membuat deskripsi terasa nyata, sedangkan majas membuat deskripsi menjadi lebih hidup.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (10,6,'Struktur Teks Eksposisi','Teks eksposisi tersusun atas tesis, rangkaian argumen, dan penegasan ulang.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (11,7,'Besaran Pokok dan Besaran Turunan','Terdapat tujuh besaran pokok dalam Sistem Internasional. Besaran turunan diperoleh dari kombinasi besaran-besaran pokok tersebut.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (12,7,'Modul Besaran dan Satuan (PDF)','Modul besaran, satuan, dan angka penting.','file','modul_besaran_satuan.pdf',NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (13,8,'Penjumlahan Vektor','Vektor dapat dijumlahkan dengan metode segitiga, jajargenjang, maupun poligon.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (14,8,'Video Pengayaan: Konsep Vektor','Tautan video pengayaan mengenai konsep vektor dan penguraiannya.','link',NULL,'https://www.youtube.com/watch?v=fNk_zzaMoSs','2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (15,9,'Generic Structure of Descriptive Text','A descriptive text consists of identification and description. It commonly uses simple present tense.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (16,10,'Perkembangan Model Atom','Model atom berkembang mulai dari Dalton, Thomson, Rutherford, Bohr, hingga model mekanika kuantum.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (17,11,'Empat Fondasi Berpikir Komputasional','Berpikir komputasional mencakup dekomposisi, pengenalan pola, abstraksi, dan perancangan algoritma.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (18,12,'Pengantar Persamaan Linear','Materi pengantar persamaan linear satu variabel beserta contohnya.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (19,13,'Struktur Teks Prosedur Kompleks','Teks prosedur kompleks memuat tujuan, langkah-langkah, dan penegasan hasil.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (20,14,'Rumus Suku ke-n Barisan Aritmetika','Suku ke-n barisan aritmetika dirumuskan Un = a + (n-1)b.','teks',NULL,NULL,'2026-09-22 14:57:11');
INSERT INTO `materi` (`id`, `id_pertemuan`, `judul`, `konten`, `tipe`, `file`, `url`, `tgl_upload`) VALUES (21,15,'Struktur Teks Negosiasi','Teks negosiasi terdiri atas orientasi, pengajuan, penawaran, dan persetujuan.','teks',NULL,NULL,'2026-09-22 14:57:11');
...
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (1,1,'Latihan Persamaan Linear','Kerjakan soal nomor 1-10 pada buku paket halaman 25. Tulis langkah penyelesaian secara lengkap, lalu unggah dalam bentuk file atau tuliskan pada kolom jawaban.','2026-10-01 23:59:00','tugas','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (2,2,'Kuis Persamaan dan Pertidaksamaan Linear','Kuis pilihan ganda mengenai persamaan dan pertidaksamaan linear satu variabel. Dinilai otomatis oleh sistem.','2026-09-27 23:59:00','kuis','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (3,3,'Tugas Proyek SPLDV','Susunlah satu soal cerita yang dapat diselesaikan dengan SPLDV beserta penyelesaiannya, kemudian unggah dalam bentuk dokumen.','2026-09-24 23:59:00','tugas','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (4,4,'Tugas Menulis Teks Deskripsi','Buatlah sebuah teks deskripsi bertema \"Lingkungan Sekolahku\" minimal tiga paragraf sesuai struktur yang telah dipelajari.','2026-09-29 23:59:00','tugas','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (5,5,'Kuis Teks Deskripsi','Kuis singkat mengenai struktur teks deskripsi. Terdiri atas soal pilihan ganda dan satu soal esai.','2026-09-26 23:59:00','kuis','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (6,7,'Latihan Soal Besaran dan Satuan','Kerjakan latihan konversi satuan dan penulisan angka penting pada lembar kerja yang telah dibagikan.','2026-09-19 23:59:00','tugas','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (7,9,'Kuis Descriptive Text','Short quiz about the generic structure and language features of descriptive text.','2026-09-28 23:59:00','kuis','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (8,12,'Latihan Persamaan Linear (X MIPA 2)','Kerjakan soal nomor 1-10 pada buku paket halaman 25.','2026-10-01 23:59:00','tugas','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (9,13,'Tugas Menyusun Teks Prosedur','Susunlah teks prosedur kompleks mengenai kegiatan sehari-hari di sekitar kalian.','2026-09-30 23:59:00','tugas','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (10,14,'Latihan Barisan Aritmetika','Kerjakan soal barisan dan deret aritmetika nomor 1 sampai 10.','2026-03-06 23:59:00','tugas','2026-09-22 14:57:11');
INSERT INTO `tugas` (`id`, `id_pertemuan`, `judul`, `deskripsi`, `deadline`, `tipe`, `created_at`) VALUES (11,15,'Tugas Menyusun Teks Negosiasi','Susunlah sebuah teks negosiasi jual beli sesuai struktur yang telah dipelajari.','2026-03-01 23:59:00','tugas','2026-09-22 14:57:11');
...
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (7,2,1,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (8,2,2,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (9,2,3,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (10,2,4,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (11,2,5,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (12,2,6,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (13,5,1,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (14,5,2,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (15,5,6,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (16,5,4,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (17,5,5,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (18,1,1,'1790089033470_jawaban_ahmad.txt','Nomor 1: 2x + 6 = 14 -> 2x = 8 -> x = 4.\r\nNomor 2: 3x - 9 = 0 -> 3x = 9 -> x = 3.\r\nNomor 3: 5x = 3x + 12 -> 2x = 12 -> x = 6.\r\nLangkah selengkapnya saya lampirkan pada berkas.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (19,1,2,'1790089033479_jawaban_dewi.txt','Seluruh soal nomor 1 sampai 10 telah saya kerjakan. Hasil pekerjaan saya tulis tangan lalu saya pindai dan lampirkan pada berkas terlampir.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (20,1,3,'1790089033488_jawaban_rian.txt','Nomor 1 sampai 8 sudah saya kerjakan, nomor 9 dan 10 masih saya ragu pada langkah pemindahan ruas. Mohon koreksinya, Pak.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (21,1,4,'1790089033496_jawaban_aisyah.txt','Jawaban lengkap nomor 1-10 terlampir pada berkas. Setiap nomor saya sertakan langkah pengerjaannya.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (22,1,6,'1790089033504_jawaban_putri.txt','Semua soal telah saya kerjakan beserta langkah-langkahnya, terlampir pada berkas jawaban.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (23,4,2,NULL,'Lingkungan Sekolahku\r\n\r\nSMA Negeri 1 Karau Kuala berdiri di tepi jalan utama Kecamatan Karau Kuala. Bangunannya bercat putih dengan lis biru yang tampak bersih setiap pagi.\r\n\r\nHalaman sekolah cukup luas dan ditumbuhi rumput hijau. Di tengahnya berdiri tiang bendera, sementara di sisi kiri berjajar pohon ketapang yang rindang.\r\n\r\nSuasana sekolahku sangat nyaman untuk belajar. Angin sejuk dari arah sungai membuat udara di ruang kelas tidak pernah terasa panas.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (24,4,6,NULL,'Lingkungan Sekolahku\r\n\r\nSekolahku terletak tidak jauh dari permukiman warga sehingga mudah dijangkau dengan sepeda.\r\n\r\nDi dalam kompleks sekolah terdapat dua belas ruang kelas, satu perpustakaan, dan sebuah laboratorium IPA. Lorong penghubungnya beratap seng sehingga siswa tetap terlindung ketika hujan.\r\n\r\nSetiap sudut sekolah dijaga kebersihannya oleh seluruh warga sekolah sehingga suasananya selalu asri.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (25,4,4,NULL,'Lingkungan Sekolahku\r\n\r\nGerbang sekolahku bercat hijau tua dan selalu terbuka sejak pukul enam pagi.\r\n\r\nDi sebelah kanan gerbang terdapat taman kecil dengan bunga kertas berwarna merah muda. Lapangan upacara berada tepat di tengah kompleks sekolah.\r\n\r\nAku sangat menyukai suasana sekolahku, terutama pada pagi hari ketika embun masih menempel di rumput lapangan.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (26,4,1,NULL,'Lingkungan Sekolahku\r\n\r\nSMA Negeri 1 Karau Kuala memiliki halaman depan yang luas dengan pagar besi berwarna hijau.\r\n\r\nRuang kelas berjajar rapi menghadap lapangan. Setiap kelas memiliki jendela besar sehingga cahaya matahari masuk dengan leluasa.\r\n\r\nKarena lingkungannya rindang dan bersih, aku merasa betah berlama-lama di sekolah.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (27,3,2,NULL,'Soal cerita: Harga 2 buku dan 3 pensil Rp 21.000, sedangkan 1 buku dan 2 pensil Rp 12.000. Dengan metode eliminasi diperoleh harga buku Rp 6.000 dan pensil Rp 3.000.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (28,3,4,NULL,'Soal cerita: Harga 2 buku dan 3 pensil Rp 21.000, sedangkan 1 buku dan 2 pensil Rp 12.000. Dengan metode eliminasi diperoleh harga buku Rp 6.000 dan pensil Rp 3.000.','2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (29,6,5,NULL,'Mohon maaf Pak, saya terlambat mengumpulkan karena jaringan internet di rumah bermasalah. Latihan konversi satuan nomor 1-10 sudah saya kerjakan seluruhnya.','2026-09-22 14:57:13',1);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (30,7,1,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (31,7,2,NULL,NULL,'2026-09-22 14:57:13',0);
INSERT INTO `pengumpulan_tugas` (`id`, `id_tugas`, `id_siswa`, `file`, `jawaban`, `tgl_kumpul`, `terlambat`) VALUES (32,7,3,NULL,NULL,'2026-09-22 14:57:13',0);
...
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (7,7,NULL,80.00,NULL,'2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (8,8,NULL,100.00,NULL,'2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (9,9,NULL,60.00,NULL,'2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (10,10,NULL,100.00,NULL,'2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (11,11,NULL,40.00,NULL,'2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (12,12,NULL,80.00,NULL,'2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (13,18,1,90.00,'Langkah pengerjaan sudah runtut dan benar. Pertahankan.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (14,19,1,85.00,'Jawaban benar, tulisan pada lampiran agar diperjelas lagi.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (15,21,1,95.00,'Sangat baik, seluruh langkah penyelesaian lengkap.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (16,22,1,88.00,'Pekerjaan rapi dan jawaban tepat.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (17,20,1,75.00,'Nomor 9 dan 10 masih keliru pada pemindahan ruas. Pelajari kembali.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (18,13,2,100.00,'Deskripsi sangat hidup dan struktur sudah tepat.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (19,14,2,73.00,'Deskripsi baik, tambahkan lagi penggunaan pancaindra.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (20,15,2,96.00,'Sudah sesuai struktur, kembangkan lagi deskripsi bagiannya.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (21,30,4,98.00,'Good description with clear details.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (22,31,4,72.00,'Good description with clear details.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (23,23,2,92.00,'Struktur lengkap dan deskripsi sangat hidup.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (24,25,2,90.00,'Pemilihan diksi sangat baik dan runtut.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (25,24,2,87.00,'Sudah baik, penutup dapat dipertegas lagi.','2026-09-22 14:57:13');
INSERT INTO `nilai` (`id`, `id_kumpul`, `id_guru`, `skor`, `catatan`, `tgl_penilaian`) VALUES (26,29,3,78.00,'Jawaban benar, namun dikumpulkan melewati batas waktu.','2026-09-22 14:57:13');
...
INSERT INTO `forum_diskusi` (`id`, `id_pertemuan`, `id_user`, `judul`, `pesan`, `id_parent`, `tgl_post`) VALUES (1,1,2,'Diskusi Pertemuan 1: Persamaan Linear','Selamat pagi anak-anak. Silakan tuliskan di forum ini bagian materi persamaan linear satu variabel yang masih sulit dipahami, nanti Bapak bahas ulang pada pertemuan berikutnya.',NULL,'2026-09-22 14:57:11');
INSERT INTO `forum_diskusi` (`id`, `id_pertemuan`, `id_user`, `judul`, `pesan`, `id_parent`, `tgl_post`) VALUES (2,2,2,'Tanya Jawab Pertidaksamaan Linear','Bagian mana dari sifat pertidaksamaan yang paling sering membuat kalian keliru? Silakan tanyakan di sini.',NULL,'2026-09-22 14:57:11');
...
INSERT INTO `forum_diskusi` (`id`, `id_pertemuan`, `id_user`, `judul`, `pesan`, `id_parent`, `tgl_post`) VALUES (4,7,4,'Pengumpulan Latihan Besaran dan Satuan','Batas waktu pengumpulan latihan soal besaran dan satuan sudah berakhir. Bagi yang belum mengumpulkan, silakan hubungi Bapak dan tetap unggah pekerjaan kalian melalui sistem.',NULL,'2026-09-22 14:57:11');
INSERT INTO `forum_diskusi` (`id`, `id_pertemuan`, `id_user`, `judul`, `pesan`, `id_parent`, `tgl_post`) VALUES (5,1,2,'Kesulitan pada Latihan Persamaan Linear','Anak-anak, bagian mana dari latihan persamaan linear yang masih terasa sulit? Tuliskan di sini agar Bapak bahas kembali pada pertemuan berikutnya.',NULL,'2026-09-22 14:57:13');
INSERT INTO `forum_diskusi` (`id`, `id_pertemuan`, `id_user`, `judul`, `pesan`, `id_parent`, `tgl_post`) VALUES (6,1,8,NULL,'Saya masih bingung ketika variabel berada di kedua ruas, contohnya 5x = 3x + 12, Pak.',5,'2026-09-22 14:57:13');
INSERT INTO `forum_diskusi` (`id`, `id_pertemuan`, `id_user`, `judul`, `pesan`, `id_parent`, `tgl_post`) VALUES (7,1,2,NULL,'Pertanyaan bagus, Ahmad. Pindahkan semua suku yang memuat variabel ke ruas kiri sehingga menjadi 5x - 3x = 12, lalu 2x = 12 dan x = 6.',5,'2026-09-22 14:57:13');
INSERT INTO `forum_diskusi` (`id`, `id_pertemuan`, `id_user`, `judul`, `pesan`, `id_parent`, `tgl_post`) VALUES (8,1,9,NULL,'Terima kasih Pak, penjelasannya sudah jelas. Berarti tandanya berubah saat pindah ruas ya, Pak.',5,'2026-09-22 14:57:13');
